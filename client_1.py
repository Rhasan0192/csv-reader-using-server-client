...
print("http://127.0.0.1:5000/query?rfw_id={}&benchmark_type={}&workload_metric={}&batch_unit={}&batch_id={}&batch_size={}".format(rfw_id,benchmark_type,workload_metric,batch_unit,batch_id,batch_size))
